...
{
       0,     0,     3,     4,     7,    11,    16,    18,    22,    25,
      28,    30,    35,    40,    43,    54,    57,    60,    62,    64,
      67,    70,    73,    76,    79,    82,    84,    86,    88,    91,
      94,    97,   100,   102,   105,   108,   110
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      32,     0,    -1,    -1,    32,    33,    -1,     3,    34,     4,
      -1,    24,    34,    43,    23,    -1,     8,    -1,    34,    25,
      35,    -1,    34,    35,    -1,    27,     8,    -1,     8,    -1,
      35,    28,    36,    29,    -1,     5,    41,     6,     4,    -1,
       7,     4,    -1,    14,    39,    15,    39,    25,    16,    39,
      25,    17,     4,    -1,    26,    36,    -1,    27,     8,    -1,
      30,    -1,     8,    -1,    36,    37,    -1,     9,    38,    -1,
      10,    38,    -1,    11,    38,    -1,    12,    38,    -1,    13,
      38,    -1,     8,    -1,    30,    -1,     8,    -1,    39,    40,
      -1,    18,    30,    -1,    21,     8,    -1,    22,     8,    -1,
       8,    -1,    41,    42,    -1,    21,    30,    -1,    25,    -1,
      -1
};
...
{
       0,    82,    82,    83,    85,    95,   114,   129,   130,   131,
     152,   174,   175,   176,   185,   186,   187,   210,   229,   250,
     252,   255,   258,   264,   270,   277,   295,   303,   316,   317,
     324,   331,   339,   347,   349,   360,   361
};
#endif
...
{
  "$end", "error", "$undefined", "DECLARE", "ENDLINE", "WHILE", "DO",
  "ENDWHILE", "VARIABLE", "PLUS", "MINUS", "MNOZENIE", "DZIELENIE",
  "RESZTA", "IF", "THEN", "ELSE", "ENDIF", "PUT", "WIEROW", "MNIROW",
  "WIEKSZE", "MNIEJSZE", "END", "IN", "ENDINS", "PRZYPISANIE", "GET",
  "LNAW", "PNAW", "LICZBA", "$accept", "input", "line", "expe", "expt",
  "expq", "expw", "expr", "expy", "expu", "expz", "expx", "expc", 0
};
#endif
...
{
       2,     0,     1,     0,     0,     3,     6,     0,     0,    36,
       9,     4,     0,     0,    10,     0,     0,     0,     0,     8,
      35,     0,    32,     0,    13,    27,     0,     0,     7,    18,
      17,    15,    16,     0,     5,     0,     0,    33,    29,     0,
       0,     0,    28,     0,     0,     0,     0,     0,    19,     0,
      12,    34,     0,    30,    31,    25,    26,    20,    21,    22,
      23,    24,    11,     0,     0,     0,     0,     0,    14
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     5,     8,    19,    31,    48,    57,    27,    42,
      23,    37,    21
};
...
{
     -40,     2,   -40,    -5,    -5,   -40,   -40,     5,     3,     7,
     -40,   -40,    10,    20,   -40,    32,    30,    -7,    19,   -22,
      30,    16,   -40,    -2,   -40,   -40,    11,    21,   -22,   -40,
     -40,    42,   -40,    -7,   -40,    59,    40,   -40,   -40,    32,
      63,    64,   -40,     1,     1,     1,     1,     1,   -40,    36,
     -40,   -40,    37,   -40,   -40,   -40,   -40,   -40,   -40,   -40,
     -40,   -40,   -40,    57,    32,    39,    58,    70,   -40
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -40,   -40,   -40,    72,     0,    44,   -40,    22,   -39,   -40,
     -40,   -40,   -40
};
...
{
      52,    29,     2,     6,    35,     3,    33,    11,    12,    55,
      13,    14,    12,    10,    13,    14,    28,    15,    22,    36,
      28,    15,     7,    30,    24,    65,     4,    32,    16,    17,
      18,    56,    20,    17,    18,    12,    39,    13,    14,    34,
      25,    38,    40,    41,    15,    43,    44,    45,    46,    47,
      26,    43,    44,    45,    46,    47,    17,    18,    40,    41,
      40,    41,    63,    50,    66,    62,    58,    59,    60,    61,
      51,    53,    54,    64,    68,    67,     9,    49
};

static const yytype_uint8 yycheck[] =
{
      39,     8,     0,     8,     6,     3,    28,     4,     5,     8,
       7,     8,     5,     8,     7,     8,    16,    14,     8,    21,
      20,    14,    27,    30,     4,    64,    24,     8,    25,    26,
      27,    30,    25,    26,    27,     5,    15,     7,     8,    23,
       8,    30,    21,    22,    14,     9,    10,    11,    12,    13,
      18,     9,    10,    11,    12,    13,    26,    27,    21,    22,
      21,    22,    25,     4,    25,    29,    44,    45,    46,    47,
      30,     8,     8,    16,     4,    17,     4,    33
};
...
{
       0,    32,     0,     3,    24,    33,     8,    27,    34,    34,
       8,     4,     5,     7,     8,    14,    25,    26,    27,    35,
      25,    43,     8,    41,     4,     8,    18,    39,    35,     8,
      30,    36,     8,    28,    23,     6,    21,    42,    30,    15,
      21,    22,    40,     9,    10,    11,    12,    13,    37,    36,
       4,    30,    39,     8,     8,     8,    30,    38,    38,    38,
      38,    38,    29,    25,    16,    39,    25,    17,     4
};
